from ylz_utils.langchain.loaders.dir_loader import DirLoader
...
from ylz_utils.langchain.loaders.pdf_loader import PdfLoader
...
class LoaderLib():
   def __init__(self,langchainLib):
      ...
      self.pdf = PdfLoader(langchainLib)